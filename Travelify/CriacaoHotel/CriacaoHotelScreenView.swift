...
class CriacaoHotelScreenView: UIView {
    ...
    func setupItens() {
        ...
        locationText.layer.cornerRadius = 8
    ...
    func configuraConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.locationLabel.topAnchor.constraint(equalTo: self.nomeText.topAnchor, constant: 40),
            self.locationLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            self.locationLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
            
            self.locationText.topAnchor.constraint(equalTo: self.locationLabel.topAnchor, constant: 25),
            self.locationText.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            self.locationText.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
           
            self.departureDateLabel.topAnchor.constraint(equalTo: self.locationText.topAnchor, constant: 40),
            ...
            self.imageLabel.topAnchor.constraint(equalTo: self.vacanciesText.topAnchor, constant: 40),
